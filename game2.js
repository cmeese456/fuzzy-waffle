...
function startGame() {
    ...
    var fountain5 = new object(96, 94, "images/fountain3.png", 600, 280, 0, 0, "fountain");
    ...
    var tree5 = new object(64, 64, "images/trees_final.png", 536, 320, 0, 0, "tree");
    var tree6 = new object(64, 64, "images/trees_final.png", 536, 264, 0, 0, "tree");
    var tree7 = new object(64, 64, "images/trees_final.png", 696, 264, 0, 0, "tree");
    var tree8 = new object(64, 64, "images/trees_final.png", 696, 320, 0, 0, "tree");
...
function updateGameArea() {
    ...
    if (gameArea.keys && gameArea.keys[32] && ((Date.now() - lastFire) > 100)) {
        ...
        switch (direction) {
            case 0:
                projectiles.push(new object(16, 16, "images/beam_left.png", player.x, player.y + player.height / 2, 0, 0, "projectile", { direction: 0 }));
                lastFire = Date.now();
                player.image.src = "images/sword_left.png";
                break;
            case 1:
                projectiles.push(new object(16, 16, "images/beam_right.png", player.width + player.x, player.y + player.height / 2, 0, 0, "projectile", { direction: 1 }));
                lastFire = Date.now();
                player.image.src = "images/sword_right.png";
                break;
            case 2:
                projectiles.push(new object(16, 16, "images/beam_up.png", player.x + player.width / 2, player.y, 0, 0, "projectile", { direction: 2 }));
                lastFire = Date.now();
                player.image.src = "images/sword_up.png";
                break;
            case 3:
                projectiles.push(new object(16, 16, "images/beam_down.png", player.x + player.width / 2, player.y + player.height, 0, 0, "projectile", { direction: 3 }));
                lastFire = Date.now();
                player.image.src = "images/sword_down.png";
                break;
            //diagonal directions
            case 4:
                projectiles.push(new object(16, 16, "images/beam_up_left.png", player.x, player.y, 0, 0, "projectile", { direction: 4 }));
                lastFire = Date.now();
                player.image.src = "images/sword_up.png";
                break;
            case 5:
                projectiles.push(new object(16, 16, "images/beam_up_right.png", player.x + player.width, player.y, 0, 0, "projectile", { direction: 5 }));
                lastFire = Date.now();
                player.image.src = "images/sword_up.png";
                break;
            case 6:
                projectiles.push(new object(16, 16, "images/beam_down_right.png", player.x + player.width, player.y + player.height, 0, 0, "projectile", { direction: 6 }));
                lastFire = Date.now();
                player.image.src = "images/sword_down.png";
                break;
            case 7:
                projectiles.push(new object(16, 16, "images/beam_down_left.png", player.x, player.y + player.height, 0, 0, "projectile", { direction: 7 }));
                lastFire = Date.now();
                player.image.src = "images/sword_down.png";
                break;
        }
